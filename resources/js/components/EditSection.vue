                    ...
                    <div class="table-responsive">
                        ...
                        <div v-else>
                            <form @submit.prevent="onSubmit" ref="createBill" enctype="multipart/form-data">
                                ...
                                <div class="form-group row" v-if="form.direct_content_question_id == 2 && form.youtube_question_id == 2 && form.iframe_question_id == 2">
                                    <div class="col-sm-4">
        ...
        methods: {
            ...
            async getPost() {
                try {
                    ...
                    if (this.post.video_id != 0 && this.post.video_id != null && this.post.video_id != '') {
