		    ...
		    <div class="col-6" v-for="(post, index) in posts" v-bind:index="index">
                <div v-if="post.special_section_id == 1">
                    ...
                    <div v-if="post.section_id == 82">
                        <a @click.native="Track(post.google_tag)" class="boton2" :style="{ background: post.color}" href="tel:226043712" target="_blank">
                            <font class="section_title">Salcobrand2</font><br><center><img style="width: 50px;" :src="'/../frontend/images/salcobrand-seeklogo.com.png'" alt=""></center>
                        </a>
                    </div>
